...
const Newsletter = () => {
    ...
    return (
        <div className='mt-[6rem] mb-10 rounded-lg bg-slate-200 flex flex-col justify-center items-center gap-4 container mx-auto px-5 py-[80px]'>
            <h2 className="text-3xl md:text-5xl capitalize text-main font-semibold text-center"
                data-aos="slide-down"
                data-aos-mirror="true"
                data-aos-once="false"
                data-aos-anchor-placement="top-bottom">Join Automotive Car</h2>
            ...
            <div className='w-full md:w-[65%] lg:w-[35%] flex justify-center items-center mt-5'>
                ...
                <input type="submit" value="Sign up" className='text-white bg-sky-400 text-[18px] font-semibold px-8 py-5 cursor-pointer hover:bg-black duration-500 rounded-r-[50px]' />
            </div>
        </div>
    );
};
