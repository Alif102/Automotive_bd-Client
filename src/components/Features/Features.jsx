...
const Features = () => {
    ...
    <div className="w-[90vw] mx-auto min-h-[80vh] mb-44">
        <h1 className="xl:text-6xl text-5xl text-center font-semibold mb-4" data-aos='zoom-out-down' data-aos-delay="500">Our <Title>Features</Title></h1>
        ...
        <div className="flex md:flex-row gap-10 flex-col items-center justify-center">
            <div className="md:w-1/3 sm:w-1/2 overflow-hidden rounded-3xl ">
            ...
            <div className="md:w-1/2 grid md:grid-cols-2 grid-cols-1 place-items-center place-content-center gap-14">
                <div className="text-center flex justify-between h-52 flex-col items-center">
                    <MdOutlineSettingsSuggest className="md:text-8xl text-6xl"/>
                    <h1 className="text-2xl font-bold">Custom Car Creations</h1>
                    <p className="md:text-base text-sm">Design your own car with personalized features and colors.</p>
                </div>
                <div className="text-center flex justify-between h-52 flex-col items-center">
                    <FaCar className="md:text-8xl text-6xl"/>
                    <h1 className="text-2xl font-bold">Virtual Test Drives</h1>
                    <p className="md:text-base text-sm">Experience our cars virtually, providing preview before making a purchase.</p>
                </div>
                <div className="text-center flex justify-between h-52 flex-col items-center">
